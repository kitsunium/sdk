...
│                  proc, scheduler, token, transform, validation, writer
│                  proc, scheduler, session, token, transform, writer
│                  metrics, proc, scheduler, token, transform, writer
└── service/       concrete implementations
                   ...
                   metrics (in-memory meter + text/prometheus exporters)
