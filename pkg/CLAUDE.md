...
| Major | Purpose | State |
|---|---|---|
| `v1/` | Stable public API for logging, error introspection, and codec dispatch (13 codecs covering 21 Format names — incl. base-N family via uniform `codec.Marshal`/`Unmarshal`) | Shipping |
