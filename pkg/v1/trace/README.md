...
[Recorder](<#Recorder>).Collect drains the finished spans; [EncodeOTLPJSON](<#EncodeOTLPJSON>) turns them into the bytes an OTLP collector accepts, and [NewOTLPHTTPExporter](<#NewOTLPHTTPExporter>) POSTs them.
