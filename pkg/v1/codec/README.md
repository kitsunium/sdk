...
One verb, twenty\-three formats. [Marshal](<#Marshal>) and [Unmarshal](<#Unmarshal>) reach every encoding the SDK ships — JSON, YAML, CBOR, MessagePack, BSON, NDJSON, XML, TOML, CSV, ASN.1 DER, PEM, TLV, FlatBuffers, multipart/form\-data, plus the nine base\-N variants \(base64, base64url, base32, base16, base45, base58, base62, hex, ascii85\). Format\-swap at runtime is a single string change.
...
- Zero registration code. Blank\-import the package; the 15 service codecs self\-register via init\(\). No Register\(\) calls in consumer code.
...
<a name="Marshal"></a>
## func [Marshal](<https://github.com/kitsunium/sdk/blob/main/pkg/v1/codec/codec.go#L251>)
...
## func [MarshalMany](<https://github.com/kitsunium/sdk/blob/main/pkg/v1/codec/codec.go#L317>)
...
<a name="Unmarshal"></a>
## func [Unmarshal](<https://github.com/kitsunium/sdk/blob/main/pkg/v1/codec/codec.go#L276>)
...
<a name="Codec"></a>
## type [Codec](<https://github.com/kitsunium/sdk/blob/main/pkg/v1/codec/codec.go#L169>)
...
<a name="Decoder"></a>
## type [Decoder](<https://github.com/kitsunium/sdk/blob/main/pkg/v1/codec/codec.go#L175>)
...
<a name="NewDecoder"></a>
### func [NewDecoder](<https://github.com/kitsunium/sdk/blob/main/pkg/v1/codec/codec.go#L390>)
...
<a name="Encoder"></a>
## type [Encoder](<https://github.com/kitsunium/sdk/blob/main/pkg/v1/codec/codec.go#L172>)
...
<a name="NewEncoder"></a>
### func [NewEncoder](<https://github.com/kitsunium/sdk/blob/main/pkg/v1/codec/codec.go#L377>)
...
<a name="Format"></a>
## type [Format](<https://github.com/kitsunium/sdk/blob/main/pkg/v1/codec/codec.go#L166>)
...
<a name="Available"></a>
### func [Available](<https://github.com/kitsunium/sdk/blob/main/pkg/v1/codec/codec.go#L403>)
...
### func [FromExtension](<https://github.com/kitsunium/sdk/blob/main/pkg/v1/codec/codec.go#L422>)
...
<a name="FromMIME"></a>
### func [FromMIME](<https://github.com/kitsunium/sdk/blob/main/pkg/v1/codec/codec.go#L409>)
