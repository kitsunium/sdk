...
| `codec/` | Universal codec dispatch: `Marshal` / `Unmarshal` / `NewEncoder` / `NewDecoder` over a `Format` registry; blank-imports 15 service codecs covering 23 Format names — text/binary/base-N/container reached identically (asn1-der, baseenc family [base64/base64url/base32/base16/hex/ascii85/base45/base58/base62], bson, cbor, csv, flatbuffers, json, msgpack, multipart, ndjson, pem, tlv, toml, xml, yaml) | _(no README)_ |
...
- `import _ "github.com/kitsunium/sdk/pkg/v1/codec"` is enough to activate all 15 service codecs (23 Format names incl. base-N family) — registry side-effects driven by blank imports.
