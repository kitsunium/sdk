...
// the cache root itself — which is Label's fallback, shared so the two cannot
// drift into scoping a cache and labelling a key differently.
...
func misconfigured(detail string) error {
	...
	return errs.Wrap(nil, errs.WrapParams{
		Code:    coreent.CodeProductInvalid,
		Reason:  "PRODUCT_INVALID",
		Public:  "the entitlement product is misconfigured",
		Private: "internal/service/entitlement: " + detail,
	})
}
...
func (s *originScan) admit(origin coreent.OriginValue) {
