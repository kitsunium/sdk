...
// TestAllocBudget pins PEM's per-call allocation ceilings for Marshal and
// Unmarshal over a small fixed block. Carries //go:build !race
...
func TestAllocBudget(t *testing.T) {
	payload := &pem.Block{Type: "TEST", Bytes: []byte("hello world")}
	c := pem.New()
