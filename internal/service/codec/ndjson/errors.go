...
var (
	...
	MarshalFailed = errs.Define(CodeNDJSONMarshalFailed, "MARSHAL_FAILED",
	...
	UnmarshalFailed = errs.Define(CodeNDJSONUnmarshalFailed, "UNMARSHAL_FAILED",
	...
	ValueInvalid = errs.Define(CodeNDJSONValueInvalid, "VALUE_INVALID",
