...
//
// Untyped constants (no `int` / no `errs.Code` annotation) so Go auto-
// converts them at the Define call site into errs.Code without requiring
// an import cycle or an `errs.Code(...)` cast.
package errs
...
const (
	...
	CodeInvalidWrapParams = 0x00_00_00_06 // 0.0.0.6
)
