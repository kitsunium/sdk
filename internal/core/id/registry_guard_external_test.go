...
type typedNilPlug struct{ id.Generator }
...
func TestRegisterRefusesAPlugInTheRegistryCannotStore(t *testing.T) {
	...
	tests := []struct {
		...
		{"a typed nil generator", func() { id.Register(typedNil) }, "nil *id_test.typedNilPlug"},
		{"a non-comparable generator", func() { id.Register(uncomparablePlug{tags: []string{"x"}}) }, "id_test.uncomparablePlug is not comparable"},
	}
