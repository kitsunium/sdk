...
type typedNilPlug struct{ codec.Codec }
...
func TestRegisterRefusesAPlugInTheRegistryCannotStore(t *testing.T) {
	...
	tests := []struct {
		...
		{"a typed nil codec", func() { codec.Register(typedNil) }, "nil *codec_test.typedNilPlug"},
		{"a non-comparable codec", func() { codec.Register(uncomparablePlug{tags: []string{"x"}}) }, "codec_test.uncomparablePlug is not comparable"},
	}
