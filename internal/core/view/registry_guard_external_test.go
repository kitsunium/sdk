...
import (
	...
	"github.com/kitsunium/sdk/internal/core/view"
)
...
type typedNilPlug struct{ view.Factory }
...
func TestRegisterRefusesAPlugInTheRegistryCannotStore(t *testing.T) {
	...
	tests := []struct {
		...
		{"a typed nil factory", func() { view.Register(typedNil) }, "nil *view_test.typedNilPlug"},
		{"a non-comparable factory", func() { view.Register(uncomparablePlug{tags: []string{"x"}}) }, "view_test.uncomparablePlug is not comparable"},
	}
