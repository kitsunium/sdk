		...
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.wantErr {
				if !errors.Is(err, ErrCIUnverifiable) {
					t.Errorf("jwtSegments() error = %v, want ErrCIUnverifiable (%s)", err, tt.reason)
				}
				return
			}
			if err != nil {
...
func Test_strictUnmarshal(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.wantErr && !errors.Is(err, ErrCIUnverifiable) {
				t.Errorf("strictUnmarshal() error = %v, want ErrCIUnverifiable", err)
			}
...
func Test_checkHeaderShape(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.wantErr && !errors.Is(err, ErrCIUnverifiable) {
				t.Errorf("checkHeaderShape() error = %v, want ErrCIUnverifiable (%s)", err, tt.reason)
			}
			if !tt.wantErr && err != nil {
...
func Test_checkHeader(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.wantErr {
				if !errors.Is(err, ErrCIUnverifiable) {
					t.Errorf("checkHeader() error = %v, want ErrCIUnverifiable (%s)", err, tt.reason)
				}
				return
			}
			if err != nil {
...
func Test_checkTiming(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.wantErr && !errors.Is(err, ErrCIUnverifiable) {
				t.Errorf("checkTiming() error = %v, want ErrCIUnverifiable (%s)", err, tt.reason)
			}
			if !tt.wantErr && err != nil {
...
func Test_checkTimingRequiresBounds(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := checkTiming(&tt.claims, now); !errors.Is(err, ErrCIUnverifiable) {
				t.Errorf("checkTiming() error = %v, want ErrCIUnverifiable", err)
			}
		})
	}
}
...
func Test_checkClaims(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.wantErr && !errors.Is(err, ErrCIUnverifiable) {
				t.Errorf("checkClaims() error = %v, want ErrCIUnverifiable (%s)", err, tt.reason)
			}
			if !tt.wantErr && err != nil {
...
func Test_verifySignature(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.wantErr && !errors.Is(err, ErrCIUnverifiable) {
				t.Errorf("verifySignature() error = %v, want ErrCIUnverifiable (%s)", err, tt.reason)
			}
			if !tt.wantErr && err != nil {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.wantErr {
				...
				if !errors.Is(err, ErrCIUnverifiable) {
					t.Errorf("UnmarshalJSON() error = %v, want ErrCIUnverifiable", err)
				}
				return
			}
			if err != nil {
...
func Test_jwkNumbers(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.wantErr && !errors.Is(err, ErrCIUnverifiable) {
				t.Errorf("jwkNumbers() error = %v, want ErrCIUnverifiable", err)
			}
			if !tt.wantErr && err != nil {
...
func Test_jwkExponent(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.wantErr {
				if !errors.Is(err, ErrCIUnverifiable) {
					t.Errorf("jwkExponent() error = %v, want ErrCIUnverifiable", err)
				}
				return
			}
			if err != nil {
...
func Test_rsaKeyFromJWK(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.wantErr {
				if !errors.Is(keyErr, ErrCIUnverifiable) {
					t.Errorf("rsaKeyFromJWK() error = %v, want ErrCIUnverifiable (%s)", keyErr, tt.reason)
				}
				return
			}
			if keyErr != nil {
