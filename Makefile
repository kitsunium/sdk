...
docs-readme:
	...
	cd pkg/v1 && go generate ./cache ./codec ./crypto ./errs ./hash ./id ./metrics ./resilience ./sign ./kdf ./password ./logger ./logger/writer
	@echo "→ pkg/v1/{cache,codec,crypto,errs,hash,id,metrics,resilience,sign,kdf,password,logger,logger/writer}/README.md regenerated"
