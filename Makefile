...
help: ## Print this help (default goal).
	...
	@printf "  $(GREEN)%-7s$(RST)  %s\n" "docs-readme"  "$(DIM)regenerate pkg/v1/{codec,crypto,errs,hash,sign,logger,logger/writer}/README.md from doc comments (see ADR 0008)$(RST)"
...
docs-readme:
	...
	cd pkg/v1 && go generate ./codec ./crypto ./errs ./hash ./sign ./logger ./logger/writer
	@echo "→ pkg/v1/{codec,crypto,errs,hash,sign,logger,logger/writer}/README.md regenerated"
