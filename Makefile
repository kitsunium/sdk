...
help: ## Print this help (default goal).
	...
	@printf "  $(GREEN)%-7s$(RST)  %s\n" "docs-readme"  "$(DIM)regenerate pkg/v1/{codec,errs,logger,logger/writer}/README.md from doc comments (see ADR 0008)$(RST)"
...
docs-readme:
	...
	cd pkg/v1 && go generate ./codec ./errs ./logger ./logger/writer
	@echo "→ pkg/v1/{codec,errs,logger,logger/writer}/README.md regenerated"
